...
<!-- enter you answer in the space below -->
```
A promise is an object that will eventually return a value.  You can capture an error by wrapping it into a try-catch.
```
**6.** Name three processes used to make requests over `HTTP`?
<!-- enter you answer in the space below -->
```
We can use Get to request data, Post to send data, and Put to update a resource in the api.
```
...
<!-- enter you answer in the space below -->
```
We use the service to call into apis.
```
**9.** What is the purpose of encapsulation in programming?
<!-- enter you answer in the space below -->
```
It makes it easier to access and reuse things in code by limiting how far your code can go outside of an object.
```
